---
title: Batch AI のドキュメント (プレビュー)
description: Azure Batch AI は、任意のフレームワークを使用して AI モデルを実験した後、GPU クラスターや CPU クラスターでそれらを大規模にトレーニングする際に役立ちます。 Microsoft が提供するクイックスタートおよびサンプルを使用して、Batch AI の使用方法を確認してください。
services: batch-ai
author: czeumault
manager: carolz
layout: LandingPage
...
---
# <a name="batch-ai-documentation-preview"></a>Batch AI のドキュメント (プレビュー)

Azure Batch AI は、任意のフレームワークを使用して AI モデルを実験した後、GPU クラスターや CPU クラスターでそれらを大規模にトレーニングする際に役立ちます。 Microsoft が提供するクイックスタートおよびサンプルを使用して、Batch AI の使用方法を確認してください。
